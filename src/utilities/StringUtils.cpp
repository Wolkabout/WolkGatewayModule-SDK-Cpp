...
bool StringUtils::contains(const std::string &string,
...
bool StringUtils::startsWith(const std::string &string,
                             const std::string &prefix) {
  return string.size() >= prefix.size() &&
         0 == string.compare(0, prefix.size(), prefix);
}

bool StringUtils::endsWith(const std::string &string,
                           const std::string &suffix) {
  return string.size() >= suffix.size() &&
         0 == string.compare(string.size() - suffix.size(), suffix.size(),
                             suffix);
}
...
std::string StringUtils::removePrefix(const std::string &string,
                                      const std::string &prefix) {
...
std::string StringUtils::removeSufix(const std::string &string,
...
std::string StringUtils::removeSubstring(const std::string &string,
                                         const std::string &substring) {
...
std::string StringUtils::base64Encode(const char *bytesToEncode,
                                      unsigned int len) {
  std::string ret;
  int i = 0;
  int j = 0;
...
bool StringUtils::mqttTopicMatch(const std::string &wildcardTopic,
