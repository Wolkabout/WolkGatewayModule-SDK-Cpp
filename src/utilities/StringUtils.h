...
public:
  ...
  static std::string removePrefix(const std::string &string,
                                  const std::string &prefix);

  static std::string removeSufix(const std::string &string,
                                 const std::string &sufix);

  static std::string removeSubstring(const std::string &string,
  ...
  static bool mqttTopicMatch(const std::string &wildcardTopic,
