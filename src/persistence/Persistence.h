...
public:
   ...
   */
  virtual bool
  putSensorReading(const std::string &key,
                   std::shared_ptr<SensorReading> sensorReading) = 0;
   ...
   */
  virtual std::vector<std::shared_ptr<SensorReading>>
  getSensorReadings(const std::string &key, std::uint_fast64_t count) = 0;
   ...
   */
  virtual void removeSensorReadings(const std::string &key,
   ...
   * element can not be inserted
   */
  virtual bool putAlarm(const std::string &key,
                        std::shared_ptr<Alarm> alarm) = 0;
   ...
   * have requested number of elements
   */
  virtual std::vector<std::shared_ptr<Alarm>>
  getAlarms(const std::string &key, std::uint_fast64_t count) = 0;
   ...
   * @param count number of items to remove
   */
  virtual void removeAlarms(const std::string &key,
                            std::uint_fast64_t count) = 0;
   ...
   */
  virtual bool
  putActuatorStatus(const std::string &key,
                    std::shared_ptr<ActuatorStatus> actuatorStatus) = 0;
   ...
   * key}
   */
  virtual std::shared_ptr<ActuatorStatus>
  getActuatorStatus(const std::string &key) = 0;
