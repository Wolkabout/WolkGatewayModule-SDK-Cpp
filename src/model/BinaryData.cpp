...
BinaryData::BinaryData(const ByteArray &value)
    : m_value{value}, m_data{}, m_hash{}, m_previousHash{} {
  ...
  m_previousHash = {m_value.begin(),
                    m_value.begin() + ByteUtils::SHA_256_HASH_BYTE_LENGTH};
...
const ByteArray &BinaryData::getData() const { return m_data; }

const ByteArray &BinaryData::getHash() const { return m_hash; }
