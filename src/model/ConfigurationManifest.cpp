...
ConfigurationManifest::ConfigurationManifest(
    std::string name, std::string reference, std::string description,
    ...
    : m_name(std::move(name)), m_reference(std::move(reference)),
      ...
      m_dataType(dataType), m_minimum(minimum), m_maximum(maximum),
      m_size(size), m_delimiter(std::move(delimiter)),
      m_collapseKey(std::move(collapseKey)),
      m_defaultValue(std::move(defaultValue)),
      m_nullValue(std::move(nullValue)), m_isOptional(isOptional) {}

const std::string &ConfigurationManifest::getName() const { return m_name; }
...
const std::string &ConfigurationManifest::getUnit() const { return m_unit; }
...
double ConfigurationManifest::getMinimum() const { return m_minimum; }
...
double ConfigurationManifest::getMaximum() const { return m_maximum; }
...
unsigned int ConfigurationManifest::getSize() const { return m_size; }
...
bool ConfigurationManifest::isOptional() const { return m_isOptional; }
