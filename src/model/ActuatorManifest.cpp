...
namespace wolkabout {
ActuatorManifest::ActuatorManifest(std::string name, std::string reference,
                                   std::string description, std::string unit,
                                   std::string readingType,
                                   ActuatorManifest::DataType dataType,
...
const std::string &ActuatorManifest::getName() const { return m_name; }

wolkabout::ActuatorManifest &
...
const std::string &ActuatorManifest::getUnit() const { return m_unit; }
...
unsigned int ActuatorManifest::getPrecision() const { return m_precision; }
...
double ActuatorManifest::getMinimum() const { return m_minimum; }
...
double ActuatorManifest::getMaximum() const { return m_maximum; }
