...
class FileDownloadService : public WolkaboutFileDownloader,
                            public BinaryDataListener {
public:
  FileDownloadService(
  ...
  void
  download(const std::string &fileName, std::uint_fast64_t fileSize,
...
private:
  ...
  public:
    FileDownloadServiceState(FileDownloadService &service)
        : m_service{service} {}
