...
public:
  ...
  void addAlarm(const std::string &deviceKey, const std::string &reference,
                const std::string &value, unsigned long long int rtc = 0);
   ...
   */
  void publishActuatorStatus(const std::string &deviceKey,
...
private:
  ...
  void handleActuatorSetCommand(const std::string &key,
                                const std::string &reference,
                                const std::string &value);
  void handleActuatorGetCommand(const std::string &key,
                                const std::string &reference);
  ...
  bool sensorDefinedForDevice(const std::string &deviceKey,
                              const std::string &reference);
  bool alarmDefinedForDevice(const std::string &deviceKey,
                             const std::string &reference);
  bool actuatorDefinedForDevice(const std::string &deviceKey,
                                const std::string &reference);

  void handleRegistrationResponse(const std::string &deviceKey,
  ...
  std::function<void(const std::string &, const std::string &,
                     const std::string &)>
      m_actuationHandlerLambda;
  std::shared_ptr<ActuationHandler> m_actuationHandler;

  std::function<ActuatorStatus(const std::string &, const std::string &)>
      m_actuatorStatusProviderLambda;
  ...
  public:
    ConnectivityFacade(InboundMessageHandler &handler,
