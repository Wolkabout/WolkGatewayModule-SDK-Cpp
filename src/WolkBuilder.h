...
public:
  ...
  WolkBuilder &actuationHandler(
      const std::function<void(const std::string &deviceKey,
   ...
   */
  WolkBuilder &
  actuationHandler(std::shared_ptr<ActuationHandler> actuationHandler);
  ...
  WolkBuilder &actuatorStatusProvider(
      const std::function<ActuatorStatus(const std::string &deviceKey,
                                         const std::string &reference)>
