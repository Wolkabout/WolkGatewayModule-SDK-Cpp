...
void from_json(const json& j, ActuatorSetCommand& p)
{
    ...
    p = ActuatorSetCommand("", value);
}

bool JsonParser::fromJson(const std::string& jsonString, ActuatorSetCommand& actuatorCommandDto)
{
    try
    {
