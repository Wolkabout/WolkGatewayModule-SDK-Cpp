...
DeviceConfiguration::DeviceConfiguration(std::string name, std::string key, std::string protocol, std::string localMqttUri)
: m_name(std::move(name)), m_key(std::move(key)), m_protocol(std::move(protocol)), m_localMqttUri(std::move(localMqttUri))
{
}
